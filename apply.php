...
if(isset($_POST['Register'])){
    ...
    if(empty($name) || empty($username) || empty($email) || empty($password) || empty($confirmpassword)) {
        ...
        if($password == $confirmpassword){
            ...
            $check_query = "SELECT * FROM doctor WHERE username='$username'";
            ...
            if(mysqli_num_rows($result) > 0) {
                ...
                $query ="INSERT INTO doctor (name, username, email, password) VALUES('$name', '$username', '$email', '$password')";
        ...
        <div class="row">
            <div class="col-md-6 my-2"><h5 class="text-center" style="font-size:35px;color:blue">Register Now!!!</h5>
                <form method="post" class="card" style="text-align:center; background:pink;">
                    ...
                    <p class="pp">I already have an account <a href="doctorlogin.php"><span class="reg">Login</span></a></p>
                </form></div>
